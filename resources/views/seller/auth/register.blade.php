        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('sellers.register') }}" method="POST">
                    ...
                    <!-- shop_name -->
                    <div class="input-group mb-3">
                        <input class="form-control" type="text" name="shop_name" :value="old('shop_name')" required placeholder="Shop Name">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user"></span>
                            </div>
                    ...
                    <!-- Phone -->
                    <div class="input-group mb-3">
                        <input class="form-control" type="number" name="phone" :value="old('phone')" required placeholder="Phone Number">
                        <div class="input-group-append">
                            <div class="input-group-text">
